...
const LoginPage = () => {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      if (data.email === dummyEmail && data.password === dummyPassword) {
        ...
        <GlassCard className="p-6 sm:p-8">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-col gap-3">
              <a href="/auth/google" className="flex items-center justify-center gap-2 bg-white text-gray-800 font-semibold py-2 rounded-lg shadow hover:bg-gray-100 transition-all">
                <img src="https://www.svgrepo.com/show/475656/google-color.svg" alt="Google" className="w-5 h-5" />
                Sign in with Google
              </a>
              <a href="/auth/linkedin" className="flex items-center justify-center gap-2 bg-[#0077b5] text-white font-semibold py-2 rounded-lg shadow hover:bg-[#005983] transition-all">
          ...
          <div className="mt-4 sm:mt-6 text-center space-y-2">
            ...
            <p className="text-gray-400 text-sm">
              ...
              <Link to={`/register${redirect ? `?redirect=${redirect}` : ""}`} className="text-primary-400 hover:text-primary-300 transition-colors">
                Sign up
              </Link>
            </p>
          </div>
